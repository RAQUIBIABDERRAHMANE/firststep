            ...
            <Card className="glass-card bg-blue-50/50 border-blue-100 shadow-none">
                <CardContent className="pt-6">
                    <div className="flex gap-4">
                        <Input
                            placeholder="New Category Name (e.g., Main Courses, Drinks...)"
                            value={newCatName}
            ...
            <div className="grid gap-8">
                {initialCategories.length === 0 ? (
                    <div className="text-center py-24 bg-slate-50/50 rounded-[2.5rem] border-2 border-dashed border-slate-200">
                        ...
                        <p className="text-slate-500">Add categories to organize your dishes.</p>
                    </div>
                ) : (
                                ...
                                <div className="flex items-center gap-4 flex-1">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="flex items-center gap-3 mt-1">
                                            <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">{cat.dishes?.length || 0} items</p>
                                    ...
                                    {cat.dishes?.map((dish: any) => (
                                        <div key={dish.id} className={`p-6 flex items-center justify-between group transition-all ${!dish.isActive ? 'bg-slate-50/50 grayscale-[0.5]' : 'hover:bg-slate-50/30'}`}>
                                            <div className="flex items-center gap-6">
                                                ...
                                                <div>
                                                    <div className="flex items-center gap-3 mb-1">
                                                        ...
                                                        {!dish.isActive && (
                                                            <span className="text-[10px] bg-rose-100 text-rose-600 px-2 py-0.5 rounded-lg font-black uppercase">Out of Stock</span>
                                                        )}
                                                    </div>
                                            ...
                                            <div className="flex items-center gap-8">
                                                <span className="font-black text-xl text-blue-600 tracking-tight">${dish.price.toFixed(2)}</span>
                                    ...
                                    {addingDishTo === cat.id ? (
                                        <div className="p-10 bg-slate-50/50 space-y-6 animate-in slide-in-from-top-4 duration-300 border-t border-slate-100">
                                            <div className="flex items-center justify-between mb-2">
                                                <h4 className="text-xl font-black">{editingDish ? 'Edit' : 'Add New'} Dish</h4>
                                                <div className="flex items-center gap-2">
                                                    <span className="text-sm font-bold text-slate-500">Available to order?</span>
                                                    <button
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                <div className="space-y-2">
                                                    <label className="text-xs font-black text-slate-400 uppercase ml-1">Dish Name</label>
                                                    <Input
                                            ...
                                            <div className="space-y-2">
                                                <label className="text-xs font-black text-slate-400 uppercase ml-1">Ingredients / Description</label>
                                                <Input
                                            ...
                                            <div className="space-y-2">
                                                <label className="text-xs font-black text-slate-400 uppercase ml-1">Image URL</label>
                                                <Input
