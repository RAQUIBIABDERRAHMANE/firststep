...
import EmploymentFormClient from './EmploymentFormClient'
import Link from 'next/link'
import { ArrowLeft, Briefcase, Code, Sparkles, CheckCircle2 } from 'lucide-react'

export const metadata: Metadata = {
  title: 'Rejoindre l\'équipe FirstStep | Software Developer Employment Application',
  description: 'Postulez pour rejoindre l\'équipe de développement FirstStep. Software Developer Remote & Project Revenue Share.',
}
      ...
      <div className="max-w-4xl mx-auto space-y-8 relative z-10">
        ...
        <div className="text-center space-y-4 pt-4">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-cyan-500/10 border border-cyan-500/20 text-cyan-300 text-xs font-semibold uppercase tracking-wider">
            <Briefcase className="w-4 h-4" /> Employment & Developer Partner Program
          </div>
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight text-white">
            Rejoignez <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-400 to-indigo-400">FirstStep</span> en tant que Developer
          </h1>
          <p className="text-slate-400 text-sm sm:text-base max-w-2xl mx-auto leading-relaxed">
            Postulez pour travailler sur des applications web et projets technologiques innovants. Bénéficiez d'un modèle d'accord transparent avec <span className="text-cyan-400 font-semibold">Revenue Share per project</span>.
          </p>
