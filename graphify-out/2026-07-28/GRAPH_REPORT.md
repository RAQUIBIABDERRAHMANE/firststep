# Graph Report - firststep  (2026-07-28)

## Corpus Check
- 429 files · ~554,480 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8664 nodes · 11948 edges · 324 communities (168 shown, 156 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 288 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d08d32a7`
...
- server-card.json/route.ts
- oauth-authorization-server/route.ts
- oauth-protected-resource/route.ts
- openid-configuration/route.ts
- QRScanner.tsx
- prisma.config.ts
- cabinet-system/page.tsx
- cabinet-system/[tenantSlug]/[[...path]]/page.tsx
- restaurant-website/[tenantSlug]/[[...path]]/page.tsx
- waiter/dashboard/layout.tsx
...
- sonner
- tailwindcss-animate
- migrate-print-requests.mjs
- migrate-service-price-turso.ts
- migrate-tableId.mjs
...
- RestaurantTemplateMoroccan.tsx
...
## Communities (324 total, 156 thin omitted)
...
Cohesion: 0.02
Nodes (66): we(), ae(), al(), An(), ao(), as(), bi(), Br() (+58 more)

### Community 3 - "Button.tsx"
Cohesion: 0.02
Nodes (84): td(), Yr(), ac(), addItem(), ai(), al(), allocUnsafe(), ba() (+76 more)

### Community 4 - "runtime/client.js"
Cohesion: 0.04
Nodes (52): AboutPage(), metadata, getCurrentUser(), deleteCampaign(), getCampaigns(), addMembersToList(), createEmailList(), deleteEmailList() (+44 more)

### Community 5 - "getCurrentUser"
Cohesion: 0.07
Nodes (48): EmailList, EmailListSelector(), RecipientSelectorProps, User, PrintRequest, TableInfo, CabinetClient, CabinetService (+40 more)

### Community 6 - "getWebsiteBySlug"
Cohesion: 0.04
Nodes (48): signUp(), updateCabinetAppointmentStatus(), clearChatHistory(), getChatHistory(), createCustomWebsiteRequest(), assignTableToReservation(), autoAssignTable(), deleteReservation() (+40 more)
...
### Community 8 - "mail.ts"
Cohesion: 0.06
Nodes (44): callWaiter(), createBillSplit(), getCartFromServer(), getOrderDetails(), getOrderStatus(), requestBill(), syncCartToServer(), metadata (+36 more)

### Community 9 - "restaurant.ts"
Cohesion: 0.09
Nodes (30): Ka(), #a(), apiKey(), cancelAllTransactions(), Ci(), commitTransaction(), #d(), disconnect() (+22 more)

### Community 10 - "useRestaurantLogic"
Cohesion: 0.05
Nodes (92): SignupSection(), a(), k(), l(), P(), y, #a(), cl() (+84 more)

### Community 11 - "L"
Cohesion: 0.10
Nodes (53): Ac(), addErrorMessage(), addField(), addSuggestion(), asObject(), bc(), cc(), dc() (+45 more)

### Community 12 - "cc"
Cohesion: 0.05
Nodes (16): GET(), GET(), POST(), DEFAULT_EMPLOYMENT_POSITIONS, EmploymentAgreementData, EmploymentTemplatePositions, generateEmploymentAgreementPdf(), getEmploymentTemplatePositions() (+8 more)

### Community 13 - "prisma.ts"
Cohesion: 0.05
Nodes (38): Color picker, 3D content, Advanced audio, Advanced compositions, Advanced Images, Advanced sequencing, Advanced timing, Advanced Videos (+30 more)

### Community 15 - "PrismaClient"
Cohesion: 0.12
Nodes (49): addErrorMessage(), addField(), addSuggestion(), Ar(), asObject(), Bm(), Bu(), ec() (+41 more)
...
Cohesion: 0.09
Nodes (42): createCabinetAppointment(), deleteCabinetService(), saveCabinetClient(), saveCabinetService(), chat(), getCabinetContext(), getRestaurantContext(), groq (+34 more)
...
Cohesion: 0.09
Nodes (28): commitTransaction(), da(), dd(), ed(), ga(), getTransaction(), H(), interpretNode() (+20 more)

### Community 20 - "write"
Cohesion: 0.10
Nodes (39): at(), addMarginSymbol(), afterNextNewline(), compare(), copy(), equals(), getCurrentLineLength(), getPrintWidth() (+31 more)
...
Cohesion: 0.07
Nodes (21): C(), F, g, ge(), I(), J(), m(), q() (+13 more)

### Community 23 - "slice"
Cohesion: 0.07
Nodes (41): Ae(), alloc(), allocUnsafeSlow(), byteLength(), construct(), el(), enabled(), eo() (+33 more)

### Community 24 - "devDependencies"
Cohesion: 0.08
Nodes (27): createIngredient(), createSpace(), deleteIngredient(), deleteSpace(), getCategories(), getInventory(), getLiveFloorStatus(), saveFloorPlanLayout() (+19 more)
...
Cohesion: 0.14
Nodes (32): bc(), be(), concat(), dc(), Es(), fc(), findField(), gc() (+24 more)
...
Cohesion: 0.12
Nodes (21): createCampaign(), getCampaign(), sendCampaign(), updateCampaign(), updateCampaignEmailLists(), updateCampaignRecipients(), EditCampaignPage(), PageProps (+13 more)
...
### Community 30 - "e"
Cohesion: 0.08
Nodes (39): requestPasswordReset(), confirmPayment(), createPaymentRequest(), getAllPendingPayments(), getBankAccount(), getPaymentRequest(), getUserPaymentRequests(), rejectPayment() (+31 more)

### Community 31 - "admin.ts"
Cohesion: 0.08
Nodes (29): ba(), ci(), disconnect(), ea(), enabled(), generate(), Gp(), ha() (+21 more)
...
### Community 35 - "wc"
Cohesion: 0.14
Nodes (28): le(), Bt(), findField(), fo(), getAllComputedFields(), getArgumentName(), getArgumentPath(), getComputedFields() (+20 more)
...
Cohesion: 0.10
Nodes (24): au(), bo(), cu(), dn(), eu(), fe(), G(), getAllBatchQueryCallbacks() (+16 more)
...
### Community 39 - "get"
Cohesion: 0.11
Nodes (25): ar(), destroy(), digest(), digestInto(), dp(), e(), Es(), finish() (+17 more)

### Community 40 - "Prisma__TenantWebsiteClient"
Cohesion: 0.12
...
### Community 41 - "BankAccountDelegate"
Cohesion: 0.07
Nodes (33): addItem(), $c(), Cd(), Ce(), De(), dr(), du(), el() (+25 more)

### Community 42 - "BillSplitDelegate"
Cohesion: 0.17
...
### Community 43 - "CabinetAppointmentDelegate"
Cohesion: 0.05
...
### Community 45 - "CabinetServiceDelegate"
Cohesion: 0.18
Nodes (17): Ca(), destroy(), digest(), digestInto(), e(), finish(), hp(), keccak() (+9 more)

### Community 46 - "CampaignDelegate"
Cohesion: 0.05
...
### Community 95 - "Prisma__UserClient"
Cohesion: 0.17
Nodes (11): name, prisma, seed, private, scripts, build, dev, lint (+3 more)

### Community 97 - "MergedExtensionsList"
Cohesion: 0.22
...
### Community 102 - "Prisma__RestaurantTableClient"
Cohesion: 0.07
...
### Community 124 - "Prisma__CabinetServiceClient"
Cohesion: 0.07
...
### Community 125 - "Prisma__ChatSessionClient"
Cohesion: 0.07
...
### Community 126 - "Prisma__EmailListMemberClient"
Cohesion: 0.40
Nodes (5): client, { createClient }, dotenv, generateCuid(), main()

### Community 127 - "Prisma__IngredientClient"
Cohesion: 0.33
...
### Community 143 - "Prisma__BillSplitClient"
Cohesion: 0.15
Nodes (15): De(), em(), Gn(), Ha(), jc(), mapQueryEngineResult(), nm(), Qc() (+7 more)

### Community 154 - "Prisma__TablePrintRequestClient"
Cohesion: 0.11
...
### Community 173 - "Prisma__FactureRecordClient"
Cohesion: 0.50
Nodes (4): ./generator-build, default, import, require

### Community 179 - "TypedSql"
Cohesion: 0.08
...
### Community 200 - "cabinet-system/page.tsx"
Cohesion: 0.09
...
### Community 207 - "DashboardPageWrapper.tsx"
Cohesion: 0.10
...
### Community 265 - "ExtendedSpanOptions"
Cohesion: 0.12
...
### Community 266 - "JsonConvertible"
Cohesion: 0.12
Nodes (14): App Router Structure, Architecture, Authentication, Commands, Database (Prisma + SQLite/LibSQL), Default Admin Credentials, Development Notes, Email Service (+6 more)

### Community 267 - "vercel.json"
Cohesion: 0.13
...
### Community 268 - "client/client.js"
Cohesion: 0.13
...
### Community 269 - "wasm-edge-light-loader.mjs"
Cohesion: 0.09
...
### Community 270 - "wasm-worker-loader.mjs"
Cohesion: 0.14
Nodes (13): Available transition types, Calculating total composition duration, Duration calculation, Getting the duration of a transition, Mixing transitions and overlays, Overlay example, Overlay props, Prerequisites (+5 more)

### Community 271 - "tailwind.config.ts"
Cohesion: 0.24
...
### Community 272 - "useRestaurantLogic"
Cohesion: 0.40
Nodes (5): ./index-browser, default, import, require, types

### Community 273 - "🚀 FirstStep - Project Initialization Guide"
Cohesion: 0.17
...
### Community 276 - "Adaptive Silence Detection"
Cohesion: 0.20
...
### Community 278 - "Using videos in Remotion"
Cohesion: 0.20
Nodes (9): Delaying, Looping, Pitch, Prerequisites, Sizing and Position, Speed, Trimming, Using videos in Remotion (+1 more)

### Community 279 - "EmploymentCanvasClient.tsx"
Cohesion: 0.14
Nodes (10): DEFAULT_ENABLED_MAP, DEFAULT_POSITIONS_MAP, DEFAULT_STYLES_MAP, EnabledMap, FieldConfig, FIELDS, FieldStyle, FieldStyles (+2 more)

### Community 280 - "Audio Visualization in Remotion"
Cohesion: 0.22
...
### Community 282 - "Using Animated images in Remotion"
Cohesion: 0.22
...
### Community 284 - "Using `<HtmlInCanvas>` in Remotion"
Cohesion: 0.25
...
### Community 286 - "DNS for AI Discovery (DNS-AID) Setup Guide"
Cohesion: 0.25
...
### Community 287 - "Using Three.js and React Three Fiber in Remotion"
Cohesion: 0.29
...
### Community 288 - "light-leaks.md"
Cohesion: 0.29
Nodes (6): Basic usage with TransitionSeries, Customizing the look, Light Leaks, Prerequisites, Props, Standalone usage

### Community 289 - "Measuring text in Remotion"
Cohesion: 0.29
...
- **Why does `RichTextEditor()` connect `restaurant-website/[tenantSlug]/[[...path]]/page.tsx` to `getCurrentUser`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `Link` connect `restaurant-website/[tenantSlug]/[[...path]]/page.tsx` to `runtime/client.d.ts`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `WaiterDashboard()` connect `BillSplitDelegate` to `useRestaurantLogic`?**
...
- **What connects `{fontFamily}`, `{fontFamily}`, `Props` to the rest of the system?**
  _5255 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `index.d.ts` be split into smaller, more focused modules?**
  _Cohesion score 0.000507227998985544 - nodes in this community are weakly interconnected._