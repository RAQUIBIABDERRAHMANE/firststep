...
## Corpus Check
- 1131 files · ~1,992,950 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 11369 nodes · 14865 edges · 687 communities (503 shown, 184 thin omitted)
...
## Communities (687 total, 184 thin omitted)

### Community 0 - "PrismaPromise"
Cohesion: 0.11
Nodes (5): Prisma__AnnouncementClient, Prisma__FactureRecordClient, Prisma__FactureTemplateClient, Prisma__TableCartSessionClient, PrismaPromise
...
Cohesion: 0.06
Nodes (56): EmailList, EmailListSelector(), RecipientSelectorProps, User, Member, Message, PrintRequest, TableInfo (+48 more)
...
Cohesion: 0.03
Nodes (62): Ae(), ai(), am(), as(), ba(), cl(), clone(), _cloneInto() (+54 more)

### Community 7 - "runtime/client.js"
Cohesion: 0.03
Nodes (68): An(), ao(), as(), ba(), Br(), ca(), Cd(), clone() (+60 more)

### Community 8 - "r"
Cohesion: 0.22
Nodes (14): createAnnouncement(), deleteAnnouncement(), generateAnnouncementWithAI(), getAnnouncements(), toggleAnnouncementPin(), toggleAnnouncementPublish(), updateAnnouncement(), AdminAnnouncementsClient() (+6 more)
...
### Community 10 - "L"
Cohesion: 0.08
Nodes (37): requestPasswordReset(), confirmPayment(), createPaymentRequest(), getAllPendingPayments(), getUserPaymentRequests(), rejectPayment(), updateTransferReference(), PendingPaymentsPage() (+29 more)
...
### Community 13 - "slice"
Cohesion: 0.05
Nodes (65): P(), bi(), cancelAllTransactions(), gc(), middlewareArgsToRequestArgs(), yo(), d(), ac() (+57 more)
...
Cohesion: 0.04
Nodes (46): Available effects, Custom effects, Usage, Dynamic image paths, Getting image dimensions, Sizing and positioning, Measuring DOM nodes in Remotion, Measuring element dimensions (+38 more)
...
Cohesion: 0.04
Nodes (66): AboutPage(), metadata, generateCode(), generateRecoveryCodes(), getCurrentUser(), getRecoverySettings(), getSession(), maskEmail() (+58 more)
...
### Community 26 - "write"
Cohesion: 0.10
Nodes (42): bc(), be(), concat(), dc(), el(), fc(), findField(), gc() (+34 more)
...
### Community 28 - "cn"
Cohesion: 0.07
Nodes (28): signOut(), updateCabinetAppointmentStatus(), clearChatHistory(), AdminMobileNav(), NAV_GROUPS, NavGroup, AdminSidebarNav(), NAV_GROUPS (+20 more)
...
Cohesion: 0.10
Nodes (33): createCabinetAppointment(), deleteCabinetService(), saveCabinetClient(), saveCabinetService(), chat(), getCabinetContext(), getRestaurantContext(), groq (+25 more)
...
Cohesion: 0.07
Nodes (38): getCabinetAppointments(), getCabinetClients(), getCabinetServices(), deleteMedicalHistory(), deleteMedicalRecord(), getClientMedicalProfile(), getMedicalRecords(), saveMedicalHistory() (+30 more)
...
### Community 43 - "wc"
Cohesion: 0.06
Nodes (36): getPublishedAnnouncements(), signUp(), getBankAccount(), getPaymentRequest(), addUserService(), getServices(), getUserServices(), removeUserService() (+28 more)
...
### Community 52 - "vo"
Cohesion: 0.06
Nodes (42): #a(), addItem(), $c(), commitTransaction(), da(), dd(), dr(), Es() (+34 more)
...
Cohesion: 0.11
Nodes (26): SCENES, AnimatedCursor(), AnimatedCursorProps, AudioTrack(), AudioTrackProps, BackgroundGlow(), BackgroundGlowProps, CameraRig() (+18 more)
...
### Community 68 - "write"
Cohesion: 0.09
Nodes (37): Ka(), #a(), apiKey(), cancelAllTransactions(), Ci(), commitTransaction(), #d(), disconnect() (+29 more)
...
### Community 79 - "lc"
Cohesion: 0.24
Nodes (12): GET(), POST(), GET(), POST(), DEFAULT_EMPLOYMENT_POSITIONS, EmploymentAgreementData, EmploymentTemplatePositions, generateEmploymentAgreementPdf() (+4 more)
...
Cohesion: 0.15
Nodes (19): bs(), Ca(), destroy(), digest(), digestInto(), e(), finish(), hp() (+11 more)

### Community 106 - "exports"
Cohesion: 0.07
Nodes (37): ul(), Yr(), alloc(), allocUnsafe(), allocUnsafeSlow(), Bi(), byteLength(), construct() (+29 more)
...
Cohesion: 0.18
Nodes (14): getSpaces(), getTables(), createWaiter(), deleteWaiter(), getWaiters(), loginWaiter(), updateWaiter(), TableManagementPage() (+6 more)
...
Cohesion: 0.12
Nodes (23): createBulkTables(), createIngredient(), createPrintRequest(), createTable(), deleteIngredient(), deleteTable(), getCategories(), getInventory() (+15 more)
...
Cohesion: 0.08
Nodes (32): addField(), Ce(), ci(), De(), du(), enabled(), er(), Gp() (+24 more)
...
Cohesion: 0.06
Nodes (43): callWaiter(), createBillSplit(), getCartFromServer(), getOrderDetails(), getOrderStatus(), requestBill(), syncCartToServer(), metadata (+35 more)
...
Cohesion: 0.06
Nodes (40): biggestPoly(), largestPolygon(), SignupSection(), RestaurantTemplateItalian(), {
  Decimal,
  DbNull,
  JsonNull,
  AnyNull,
...
### Community 229 - "./edge"
Cohesion: 0.09
Nodes (26): au(), bo(), cu(), dn(), eu(), fe(), G(), getAllBatchQueryCallbacks() (+18 more)
...
Cohesion: 0.22
Nodes (9): createReservation(), OrdersClient(), playNotificationSound(), DishCustomizationModal(), ReservationModal(), ReservationModalProps, RestaurantTemplateModern(), react (+1 more)
...
Cohesion: 0.10
Nodes (23): assignTableToReservation(), autoAssignTable(), deleteReservation(), getReservations(), updateReservationStatus(), ReservationsPage(), Reservation, ReservationsClient() (+15 more)
...
Cohesion: 0.21
Nodes (16): a(), C(), R(), se(), k(), Ct(), em(), ge() (+8 more)
...
Cohesion: 0.16
Nodes (16): addItem(), _c(), eo(), fs(), ft(), getAllClientExtensions(), getAllComputedFields(), getAllModelExtensions() (+8 more)

### Community 357 - "remeda"
Cohesion: 0.17
Nodes (13): constructor(), el(), getConnectionInfo(), getGlobalOmit(), id(), ie(), mapQueryEngineResult(), ol() (+5 more)
...
- **Why does `t()` connect `slice` to `wasm-compiler-edge.js`, `runtime/client.js`, `cc`, `addErrorMessage`, `getCurrentUser`, `query_compiler_bg.js`, `write`, `employment-pdf.ts`, `e`, `vo`, `write`, `local-fonts.md`, `waiter/dashboard/page.tsx`, `@react-three/postprocessing`, `remeda`, `./edge`, `restaurant-report.ts`, `@types/qrcode`, `exports`, `Adaptive Silence Detection`, `maplibre.md`, `Using videos in Remotion`, `KDSBoard.tsx`, `Audio Visualization in Remotion`, `Displaying captions in Remotion`?**
