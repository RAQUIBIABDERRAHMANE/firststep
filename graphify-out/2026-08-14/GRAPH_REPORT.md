...
## Corpus Check
- 1113 files · ~1,903,260 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 11220 nodes · 14690 edges · 674 communities (500 shown, 174 thin omitted)
...
- devDependencies
- Complete Examples
- App\Domains\Restaurant\Contracts\TableRepositoryInterface
...
- FloorPlanCanvas.tsx
- pos/composer.json
- restaurant/composer.json
- tenant/composer.json
- Prisma__UserClient
- restaurant-report.ts
- exports
- MergedExtensionsList
- App\Domains\POS\Contracts\OrderRepositoryInterface
...
- config
- config
- EmploymentAdminClient.tsx
- EmploymentCanvasClient.tsx
- config
...
- admin/waiters/page.tsx
- ./index
- ./runtime/index-browser
- EmploymentFormClient.tsx
- app/layout.tsx
...
- sw.js
- BankAccountDelegate
- identity/app/Http/Controllers/Controller.php
- pos/app/Http/Controllers/Controller.php
- restaurant/app/Http/Controllers/Controller.php
- tenant/app/Http/Controllers/Controller.php
- AnyNull
- DbNull
- JsonNull
...
- Using `<HtmlInCanvas>` in Remotion
- remotion-best-practices/remotion-markup/light-leaks.md
- Map Explainer — basemap & geo prep
- Map Explainer — basemap & geo prep
- Using `<HtmlInCanvas>` in Remotion
- skills/remotion-markup/light-leaks.md
- Map Explainer — basemap & geo prep
- Using Three.js and React Three Fiber in Remotion
- Measuring text in Remotion
...
- Using fonts in Remotion
- remotion-best-practices/remotion-markup/local-fonts.md
- Using Lottie Animations in Remotion
- Delaying, trimming
- Flyover data sources
- 3D Flyover — troubleshooting
...
- Using fonts in Remotion
- skills/remotion-markup/local-fonts.md
- Using Lottie Animations in Remotion
- Flyover data sources
- 3D Flyover — troubleshooting
...
- EmploymentAgreementTemplateDelegate
- EmploymentApplicationDelegate
...
- `CesiumFlythrough()` --indirect_call--> `C()`  [INFERRED]
  .claude/skills/remotion-best-practices/remotion-maps/techniques/cesium/assets/CesiumFlythrough.tsx → src/generated/client/query_compiler_bg.js
- `RiverReveal()` --indirect_call--> `m()`  [INFERRED]
  .claude/skills/remotion-best-practices/remotion-maps/techniques/maptiler/assets/RiverReveal.tsx → src/generated/client/query_compiler_bg.js
- `RiverReveal()` --indirect_call--> `c()`  [INFERRED]
  .claude/skills/remotion-best-practices/remotion-maps/techniques/maptiler/assets/RiverReveal.tsx → src/generated/client/runtime/index-browser.js
- `RiverReveal()` --indirect_call--> `d()`  [INFERRED]
  .claude/skills/remotion-best-practices/remotion-maps/techniques/maptiler/assets/RiverReveal.tsx → src/generated/client/runtime/index-browser.js

## Import Cycles
- None detected.

## Communities (674 total, 174 thin omitted)
...
Cohesion: 0.06
Nodes (58): generateWebsiteSuggestions(), updateCampaignEmailLists(), updateCampaignRecipients(), EmailList, EmailListSelector(), RecipientSelector(), RecipientSelectorProps, User (+50 more)

### Community 4 - "admin.ts"
Cohesion: 0.05
Nodes (60): P(), bi(), cancelAllTransactions(), commitTransaction(), gc(), middlewareArgsToRequestArgs(), rollbackTransaction(), startTransaction() (+52 more)
...
Cohesion: 0.02
Nodes (65): ul(), Yr(), ai(), alloc(), allocUnsafe(), am(), ba(), Ca() (+57 more)

### Community 7 - "runtime/client.js"
Cohesion: 0.03
Nodes (63): An(), ao(), as(), ba(), Br(), ca(), clone(), _cloneInto() (+55 more)

### Community 8 - "r"
Cohesion: 0.08
Nodes (30): biggestPoly(), largestPolygon(), SignupSection(), RestaurantTemplateItalian(), {
  Decimal,
  DbNull,
  JsonNull,
  AnyNull,
  ...
  getRuntime,
  skip
}, Prisma, PrismaClient, l() (+22 more)

### Community 9 - "cc"
Cohesion: 0.11
Nodes (51): Ac(), addErrorMessage(), addSuggestion(), asObject(), bc(), cc(), dc(), ec() (+43 more)

### Community 10 - "L"
Cohesion: 0.09
Nodes (32): requestPasswordReset(), updateInvoiceStatus(), POST(), GET(), POST(), POST(), POST(), getEmploymentApplicationAcceptedTemplate() (+24 more)
...
### Community 13 - "slice"
Cohesion: 0.13
Nodes (27): a(), C(), R(), se(), k(), Ct(), em(), enabled() (+19 more)

### Community 14 - "ts"
Cohesion: 0.11
Nodes (38): bc(), be(), concat(), dc(), fc(), findField(), ft(), gc() (+30 more)

### Community 15 - "remotion-best-practices/SKILL.md"
Cohesion: 0.04
Nodes (43): Dynamic image paths, Getting image dimensions, Sizing and positioning, Measuring DOM nodes in Remotion, Measuring element dimensions, Color picker, 3D content, Advanced compositions (+35 more)
...
Cohesion: 0.03
Nodes (80): AboutPage(), metadata, generateCode(), generateRecoveryCodes(), getCurrentUser(), getRecoverySettings(), getSession(), maskEmail() (+72 more)

### Community 19 - "query_compiler_bg.js"
Cohesion: 0.08
Nodes (14): g, ge(), I(), J(), k(), le(), m(), q() (+6 more)
...
Cohesion: 0.12
Nodes (26): confirmPayment(), createPaymentRequest(), getAllPendingPayments(), getBankAccount(), getPaymentRequest(), getUserPaymentRequests(), rejectPayment(), updateTransferReference() (+18 more)

### Community 22 - "🚀 FirstStep - Business Management Platform"
Cohesion: 0.05
Nodes (40): 🙏 Acknowledgments, 👨‍💼 Admin Dashboard, Animations, 🔐 Authentication, 🔐 Authentication System, 📦 Available Services, Backend, Code Style (+32 more)

### Community 23 - "Data Fetching Patterns"
Cohesion: 0.05
Nodes (40): Advanced Query Patterns, API Client Configuration, API Service Layer Pattern, Basic Mutation Pattern, Basic Pattern, Cache Access Without Fetching, Cache-First Pattern Example, Cache-First Strategy (+32 more)

### Community 24 - "UIUX Designer - Design Intelligence"
Cohesion: 0.05
...
### Community 25 - "Wt"
Cohesion: 0.10
Nodes (26): Bp(), Bs(), ci(), fn(), get(), Gp(), highlight(), hn() (+18 more)

### Community 26 - "write"
Cohesion: 0.24
Nodes (17): at(), addMarginSymbol(), afterNextNewline(), getCurrentLineLength(), getPrintWidth(), indent(), newLine(), setColor() (+9 more)
...
### Community 28 - "cn"
Cohesion: 0.05
Nodes (42): signUp(), createWaiter(), deleteWaiter(), loginWaiter(), updateWaiter(), AdminSidebarNav(), NavItem, AdminMarketingPage() (+34 more)

### Community 29 - "Illuminate\Database\Console\Seeds\WithoutModelEvents"
Cohesion: 0.12
Nodes (15): User, DatabaseSeeder, Illuminate\Database\Console\Seeds\WithoutModelEvents, Illuminate\Database\Eloquent\Factories\HasFactory, Illuminate\Database\Seeder, Illuminate\Foundation\Auth\User, Illuminate\Notifications\Notifiable, User (+7 more)

### Community 30 - "TypeScript Standards"
Cohesion: 0.06
Nodes (33): Basic Type Guards, Component Prop Interfaces, Component Return Types, Configuration, Discriminated Unions, Explicit Return Types, Function Return Types, Generic Components (+25 more)

### Community 31 - "FIRSTSTEP V2 - ENTERPRISE SaaS ARCHITECTURE DOCUMENTATION"
Cohesion: 0.06
...
Cohesion: 0.05
Nodes (74): createCabinetAppointment(), deleteCabinetService(), saveCabinetClient(), saveCabinetService(), updateCabinetAppointmentStatus(), chat(), clearChatHistory(), getCabinetContext() (+66 more)
...
Cohesion: 0.06
Nodes (33): @aws-sdk/client-s3, bcryptjs, clsx, html5-qrcode, idb, nodemailer, dependencies, @aws-sdk/client-s3 (+25 more)

### Community 38 - "index.js"
Cohesion: 0.08
Nodes (16): adapter, prisma, adapter, prisma, adapter, prisma, migrate(), { createClient } (+8 more)

### Community 39 - "Styling Guide"
Cohesion: 0.07
Nodes (29): Basic Usage, Code Style Standards, Common Style Patterns, Decision Threshold, Flexbox Layout, Grid Component (v7 Syntax), Indentation, Inline vs Separate Styles (+21 more)

### Community 40 - "compilerOptions"
Cohesion: 0.07
Nodes (28): dom, dom.iterable, esnext, **/*.mts, .next/dev/types/**/*.ts, next-env.d.ts, .next/types/**/*.ts, node_modules (+20 more)

### Community 41 - "Loading & Error States"
Cohesion: 0.07
...
Cohesion: 0.08
Nodes (30): generateEmailContent(), getAIComboRecommendations(), groq, improveEmailPrompt(), createCampaign(), deleteCampaign(), getCampaign(), getCampaigns() (+22 more)
...
Cohesion: 0.07
Nodes (27): Basic Configuration, Basic Route Pattern, Complete Route Example, createFileRoute, Default Export Pattern, Directory Structure, Dynamic Routes, Example from posts/index.tsx (+19 more)

### Community 45 - "Illuminate\Database\Eloquent\Factories\Factory"
Cohesion: 0.11
Nodes (11): static, UserFactory, Illuminate\Database\Eloquent\Factories\Factory, static, UserFactory, static, UserFactory, static (+3 more)

### Community 46 - "TestCase"
Cohesion: 0.10
Nodes (11): ExampleTest, TestCase, Illuminate\Foundation\Testing\TestCase, ExampleTest, TestCase, ExampleTest, TestCase, ExampleTest (+3 more)

### Community 47 - "Component Patterns"
Cohesion: 0.08
Nodes (25): Advanced Patterns, Avoid Prop Drilling, Basic Pattern, Component Communication, Component Patterns, Component Separation, Component Structure Template, Compound Components (+17 more)

### Community 48 - "Performance Optimization"
Cohesion: 0.08
Nodes (25): Abort Controllers for Fetch, Basic Usage, Cleanup Event Listeners, Cleanup Timeouts/Intervals, Code Splitting, Debounced Search, Form Performance, Key Prop Usage (+17 more)

### Community 49 - "e"
Cohesion: 0.10
Nodes (26): ar(), destroy(), digest(), digestInto(), dp(), e(), finish(), getAllBatchQueryCallbacks() (+18 more)
...
### Community 52 - "vo"
Cohesion: 0.11
Nodes (24): da(), dd(), ed(), getTransaction(), H(), He(), interpretNode(), jn() (+16 more)

### Community 53 - "📂 Topic Guides"
Cohesion: 0.09
Nodes (22): API Route Format, Common Patterns, Complete Examples, Component Patterns, 📚 Core Principles, 🚫 Critical Rules, Data Fetching, File Organization (+14 more)

### Community 54 - "Illuminate\Support\ServiceProvider"
Cohesion: 0.12
Nodes (6): AppServiceProvider, Illuminate\Support\ServiceProvider, AppServiceProvider, AppServiceProvider, AppServiceProvider, AppServiceProvider

### Community 55 - "Using calculateMetadata"
Cohesion: 0.12
Nodes (23): SCENES, AnimatedCursor(), AnimatedCursorProps, AudioTrack(), AudioTrackProps, BackgroundGlow(), BackgroundGlowProps, CaptionsOverlay() (+15 more)
...
### Community 64 - "Complete Examples"
Cohesion: 0.12
...
### Community 65 - "App\Domains\Restaurant\Contracts\TableRepositoryInterface"
Cohesion: 0.18
Nodes (5): App\Domains\Restaurant\Contracts\TableRepositoryInterface, CreateTableAction, Table, TableRepository, TableController

### Community 66 - "Illuminate\Database\Eloquent\Model"
Cohesion: 0.21
Nodes (6): Illuminate\Database\Eloquent\Concerns\HasUuids, Illuminate\Database\Eloquent\Model, Order, Payment, OrderRepository, Waiter

### Community 67 - "🗺️ Restaurant Service - Planned Features & Roadmap"
Cohesion: 0.12
...
### Community 70 - "Common Patterns"
Cohesion: 0.12
Nodes (16): Authentication with useAuth, Basic Form, Common Patterns, DataGrid Wrapper Pattern, Dialog Component Pattern, Forms with React Hook Form, Getting Current User, Mutation Patterns (+8 more)

### Community 71 - "Architecture"
Cohesion: 0.09
Nodes (21): API Routes, App Router Structure, Architecture, Authentication, Commands, Database (Prisma + SQLite/Turso), Default Admin Credentials, Development Notes (+13 more)

### Community 72 - "PHPUnit\Framework\TestCase"
Cohesion: 0.17
Nodes (6): ExampleTest, PHPUnit\Framework\TestCase, ExampleTest, ExampleTest, ExampleTest, ExampleTest

### Community 73 - "UIUX Designer"
Cohesion: 0.13
...
Cohesion: 0.08
Nodes (21): Fetching a page as Markdown, Searching the docs, Workflow, Useful flags, Upgrade Remotion, Captions, Creating a SaaS, automation or application, Creating a video (+13 more)
...
### Community 79 - "lc"
Cohesion: 0.14
Nodes (18): addItem(), bs(), _c(), getAllClientExtensions(), Ho(), Ht(), je(), Jn() (+10 more)

### Community 80 - "MenuController.php"
Cohesion: 0.24
Nodes (4): App\Domains\Restaurant\Contracts\CategoryRepositoryInterface, App\Domains\Restaurant\Contracts\DishRepositoryInterface, CreateCategoryAction, CreateDishAction

### Community 81 - "Lumina System — Implementation Log"
Cohesion: 0.17
Nodes (11): Deferred — Phase 2 (app shell), Deferred — Phase 3 (marketing), Deferred — Phase 4 (tenant sites), Deviations from the plan (deliberate, with rationale), Lumina System — Implementation Log, Phase 0 — `app/globals.css`, Phase 0 — `app/layout.tsx`, Phase 1 — Primitives (`components/ui/`) (+3 more)

### Community 82 - "🚀 FirstStep - Project Initialization Guide"
Cohesion: 0.17
Nodes (11): 🗄️ Database Initialization, 🔑 Default Admin Credentials, 🔒 Environment Configuration (`.env`), 🚀 FirstStep - Project Initialization Guide, Option A: Local Development (SQLite), Option B: Production/Staging (Turso / LibSQL), ⚙️ Prerequisites, 🧩 Prisma Client Integration Note (+3 more)

### Community 83 - "package.json"
Cohesion: 0.17
Nodes (11): name, prisma, seed, private, scripts, build, dev, lint (+3 more)

### Community 84 - "Phase 1: Shared Platform Infrastructure Implementation Plan"
Cohesion: 0.17
Nodes (11): 1. Directory Structure, 2. Docker Compose Specification, 3. Database Migration Schemas, 4. API Gateway Route & Middleware Spec, 5. Security Protocols (JWT & Session Management), 6. Verification Steps for Approval, A. Identity Service Migrations, A. Tenant Resolution Middleware (+3 more)

### Community 85 - "Phase 3: POS Module Implementation Plan"
Cohesion: 0.17
Nodes (11): 1. Directory Structure, 2. Docker Compose Integration, 3. Database Migration Schemas, 4. DDD Domain Design, 5. API Routes, 6. Offline Synchronization Flow, 7. Integration Events (RabbitMQ Integration), A. Repository Contracts (Contracts Layer) (+3 more)
...
Cohesion: 0.24
Nodes (11): callWaiter(), getOrderDetails(), getOrderStatus(), requestBill(), QRScanner, ReservationModal, RestaurantTemplateClassic(), useRestaurantLogic() (+3 more)

### Community 93 - "Frontend Expert"
Cohesion: 0.18
Nodes (10): 🎯 Core Principles, Example 1: Create a New Component, Example 2: Set Up a New Feature, 📝 Examples, Frontend Expert, 🔧 How It Works, 🚀 Quick Start, Reference Documents (+2 more)

### Community 95 - "gateway/composer.json"
Cohesion: 0.18
Nodes (10): autoload-dev, psr-4, description, license, minimum-stability, name, prefer-stable, Tests\\ (+2 more)

### Community 96 - "Phase 2: Restaurant Service Implementation Plan"
Cohesion: 0.18
Nodes (10): 1. Directory Structure, 2. Docker Compose Integration, 3. Database Migration Schemas, 4. DDD Domain Design, 5. API Routes, 6. Integration Events (RabbitMQ Integration), A. Repository Contracts (Contracts Layer), B. Core Actions (Application Layer) (+2 more)

### Community 97 - "InventoryClient.tsx"
Cohesion: 0.10
...
Cohesion: 0.06
Nodes (55): Ka(), #a(), Ae(), apiKey(), as(), cancelAllTransactions(), Ci(), cl() (+47 more)
...
### Community 111 - "maplibre.md"
Cohesion: 0.10
Nodes (21): CountryLabel(), clamp01(), Country, countryPolygons, DRAW, EMPTY, END, lerp() (+13 more)

### Community 112 - "Using videos in Remotion"
Cohesion: 0.10
Nodes (21): CountryLabel(), clamp01(), Country, countryPolygons, DRAW, EMPTY, END, lerp() (+13 more)

### Community 113 - "client/package.json"
Cohesion: 0.20
...
Cohesion: 0.20
Nodes (11): getCartFromServer(), syncCartToServer(), metadata, DishCustomizationModalProps, RestaurantTemplate(), CartContext, CartContextType, CartItem (+3 more)
...
### Community 121 - "Session"
Cohesion: 0.08
Nodes (23): 📄 1. Design Philosophy, 1. Floating Pill Navbar (`Navbar.tsx`), 🎨 2. Color Palette & Design Tokens, 2. Solutions Cards (`ServicesOverview.tsx`), 3. Timeline Sequence (`HowItWorks.tsx`), ✍️ 3. Typography & Font Hierarchy, 4. Forms & Input Fields (`SignupSection.tsx`, `app/login/page.tsx`), ✨ 4. Glassmorphism & Special Effects (+15 more)

### Community 122 - "Audio Visualization in Remotion"
Cohesion: 0.10
Nodes (21): CountryLabel(), clamp01(), Country, countryPolygons, DRAW, EMPTY, END, lerp() (+13 more)
...
Cohesion: 0.09
Nodes (26): #a(), addField(), addItem(), $c(), Cd(), Ce(), De(), dr() (+18 more)
...
### Community 126 - "What to do"
Cohesion: 0.22
Nodes (8): 1. After parsing selectedRecipients (around line 134), add:, 2. Replace the simple user fetch with this merged recipient logic:, 3. Update the loop to use recipients instead of users:, 4. Update the final stats:, Key Benefits, Location, MANUAL UPDATE REQUIRED: Campaign Send Function, What to do

### Community 127 - "Dish"
Cohesion: 0.33
Nodes (3): Illuminate\Database\Eloquent\Relations\BelongsTo, Dish, DishRepository

### Community 128 - "Category"
Cohesion: 0.33
Nodes (3): Illuminate\Database\Eloquent\Relations\HasMany, Category, CategoryRepository

### Community 131 - "e"
Cohesion: 0.11
Nodes (17): Animation Vocabulary, Easing — how speed changes over an animation, Entrances & Exits — how elements appear and disappear, Examples, Feedback & Interaction — responding to the user's actions, Glossary, Instructions, Looping & Ambient Motion — animations that run on their own (+9 more)

### Community 132 - "Using `<HtmlInCanvas>` in Remotion"
Cohesion: 0.08
Nodes (18): ANCHOR_BBOX, biggestPoly(), borders, COUNTRIES, countryMeta, __dir, flowKm, FRAME_BBOX (+10 more)

### Community 133 - "DNS for AI Discovery (DNS-AID) Setup Guide"
Cohesion: 0.25
Nodes (7): 1. DNS Records to Add, 2. Configuration by Provider, 3. Enable DNSSEC (Required), AWS Route 53, Cloudflare (Recommended), DNS for AI Discovery (DNS-AID) Setup Guide, Format

### Community 134 - "setup"
Cohesion: 0.25
Nodes (8): composer install, npm install --ignore-scripts, npm run build, @php artisan key:generate, @php artisan migrate --force, @php -r \"file_exists('.env') || copy('.env.example', '.env');\, post-root-package-install, setup

### Community 135 - "require-dev"
Cohesion: 0.25
Nodes (8): require-dev, fakerphp/faker, laravel/pail, laravel/pao, laravel/pint, mockery/mockery, nunomaduro/collision, phpunit/phpunit

### Community 136 - "gateway/README.md"
Cohesion: 0.25
Nodes (7): About Laravel, Agentic Development, Code of Conduct, Contributing, Learning Laravel, License, Security Vulnerabilities

### Community 137 - "Phase 4: POS Offline Sync & Frontend Next.js Integration"
Cohesion: 0.25
Nodes (7): 1. Directory Structure, 2. API Client Configuration, 3. IndexedDB Local Storage Schema, 4. Zustand Offline Store Specification, 5. Network Listener & Auto-Sync Pipeline, 6. Conflict Resolution & Idempotency Rules, Phase 4: POS Offline Sync & Frontend Next.js Integration

### Community 138 - "setup"
Cohesion: 0.25
Nodes (8): composer install, npm install --ignore-scripts, npm run build, @php artisan key:generate, @php artisan migrate --force, @php -r \"file_exists('.env') || copy('.env.example', '.env');\, post-root-package-install, setup

### Community 139 - "require-dev"
Cohesion: 0.25
Nodes (8): require-dev, fakerphp/faker, laravel/pail, laravel/pao, laravel/pint, mockery/mockery, nunomaduro/collision, phpunit/phpunit

### Community 140 - "identity/README.md"
Cohesion: 0.25
Nodes (7): About Laravel, Agentic Development, Code of Conduct, Contributing, Learning Laravel, License, Security Vulnerabilities
...
### Community 142 - "require-dev"
Cohesion: 0.25
Nodes (8): require-dev, fakerphp/faker, laravel/pail, laravel/pao, laravel/pint, mockery/mockery, nunomaduro/collision, phpunit/phpunit

### Community 143 - "pos/README.md"
Cohesion: 0.25
Nodes (7): About Laravel, Agentic Development, Code of Conduct, Contributing, Learning Laravel, License, Security Vulnerabilities
...
### Community 146 - "restaurant/README.md"
Cohesion: 0.25
Nodes (7): About Laravel, Agentic Development, Code of Conduct, Contributing, Learning Laravel, License, Security Vulnerabilities
...
### Community 148 - "require-dev"
Cohesion: 0.25
Nodes (8): require-dev, fakerphp/faker, laravel/pail, laravel/pao, laravel/pint, mockery/mockery, nunomaduro/collision, phpunit/phpunit

### Community 149 - "tenant/README.md"
Cohesion: 0.25
Nodes (7): About Laravel, Agentic Development, Code of Conduct, Contributing, Learning Laravel, License, Security Vulnerabilities
...
### Community 155 - "charts-bar-chart.tsx"
Cohesion: 0.08
Nodes (18): ANCHOR_BBOX, biggestPoly(), borders, COUNTRIES, countryMeta, __dir, flowKm, FRAME_BBOX (+10 more)

### Community 156 - "FactureCanvasClient.tsx"
Cohesion: 0.29
...
Cohesion: 0.09
Nodes (25): constructor(), dispatchBatches(), el(), Es(), execute(), getConnectionInfo(), getGlobalOmit(), handleAndLogRequestError() (+17 more)
...
Cohesion: 0.08
Nodes (19): Adding AI voiceover to a Remotion composition, Delaying audio start, Dynamic composition duration with calculateMetadata, Generating audio with ElevenLabs, Prerequisites, Rendering audio in the component, Getting audio duration, Getting audio duration with Mediabunny (+11 more)

### Community 160 - "sequencing.md"
Cohesion: 0.09
Nodes (19): Creating pages, Display captions alongside video content, Displaying captions in Remotion, Fetching captions, Prerequisites, Rendering with Sequences, Separate component for captions, White-space preservation (+11 more)

### Community 161 - "config"
Cohesion: 0.29
Nodes (7): pestphp/pest-plugin, php-http/discovery, config, allow-plugins, optimize-autoloader, preferred-install, sort-packages

### Community 162 - "Phase 5: Frontend Server Actions Refactor & Microservices Integration"
Cohesion: 0.29
Nodes (6): 1. Shared Server-Side Fetch Utility, 2. Refactoring Identity & Auth Actions, 3. Refactoring Tenant Actions, 4. Refactoring Restaurant & Waiter Actions, 5. DTO Adapters & Compatibility Layer, Phase 5: Frontend Server Actions Refactor & Microservices Integration

### Community 163 - "config"
Cohesion: 0.29
Nodes (7): pestphp/pest-plugin, php-http/discovery, config, allow-plugins, optimize-autoloader, preferred-install, sort-packages
...
### Community 166 - "EmploymentCanvasClient.tsx"
Cohesion: 0.15
Nodes (11): DEFAULT_ENABLED_MAP, DEFAULT_POSITIONS_MAP, DEFAULT_STYLES_MAP, EmploymentCanvasClient(), EnabledMap, FieldConfig, FIELDS, FieldStyle (+3 more)
...
### Community 175 - "al"
Cohesion: 0.07
Nodes (33): Iu(), allocUnsafeSlow(), Bi(), byteLength(), construct(), eo(), equals(), from() (+25 more)
...
### Community 180 - "migrate-and-seed-turso-custom.js"
Cohesion: 0.40
Nodes (5): client, { createClient }, dotenv, generateCuid(), main()

### Community 181 - "facture-pdf.ts"
Cohesion: 0.12
...
Cohesion: 0.14
Nodes (13): RestaurantTemplateProps, QRScanner, ReservationModal, QRScanner, ReservationModal, RestaurantTemplateLuxury(), QRScanner, ReservationModal (+5 more)
...
### Community 204 - "auth.md - FirstStep Agent Registration Instructions"
Cohesion: 0.40
Nodes (4): auth.md - FirstStep Agent Registration Instructions, Discovery, Registration, Using Credentials

### Community 205 - "export_turso_data.ts"
Cohesion: 0.60
Nodes (4): client, formatVal(), run(), toUuid()
...
Cohesion: 0.39
Nodes (9): digest(), e(), hp(), pp(), Tp(), update(), vp(), wa() (+1 more)
...
### Community 235 - "./index"
Cohesion: 0.20
Nodes (18): cm(), compare(), copy(), H(), ie(), ka(), lu(), readIntBE() (+10 more)
...
Cohesion: 0.17
Nodes (11): metadata, BookingPage(), Props, generateMetadata(), Props, TenantLayout(), Props, TenantPage() (+3 more)
...
### Community 252 - "text-animations.md"
Cohesion: 0.11
Nodes (15): Animate using `interpolate()`, Effects should be inline too, Give interactive elements a descriptive name, Keep all CSS styles inline, Keep composition metadata inline, Make an HTML element interactive using `Interactive`, Making your own component interactive, Prefer inline text (+7 more)

### Community 254 - "Rendering Transparent Videos"
Cohesion: 0.12
Nodes (13): A, AB, B, clip, __dir, even, havKm(), hs (+5 more)

### Community 256 - "trimming.md"
Cohesion: 0.12
Nodes (13): A, AB, B, clip, __dir, even, havKm(), hs (+5 more)

### Community 258 - "post-create-project-cmd"
Cohesion: 0.12
Nodes (14): Angular, Choosing a template or a framework, Rendering, Svelte, The `<Player>`, With Vue, Azure Container Apps, Cloudflare Containers (+6 more)

### Community 259 - "require"
Cohesion: 0.50
Nodes (4): require, laravel/framework, laravel/tinker, php

### Community 260 - "DashboardCharts.tsx"
Cohesion: 0.16
...
### Community 261 - "seed-turso.ts"
Cohesion: 0.67
Nodes (3): client, generateCuid(), seedDatabase()

### Community 263 - "require"
Cohesion: 0.50
Nodes (4): require, laravel/framework, laravel/tinker, php

### Community 265 - "require"
Cohesion: 0.50
Nodes (4): require, laravel/framework, laravel/tinker, php

### Community 269 - "require"
Cohesion: 0.50
Nodes (4): require, laravel/framework, laravel/tinker, php

### Community 270 - "require"
Cohesion: 0.50
Nodes (4): require, laravel/framework, laravel/tinker, php

### Community 273 - "AnimationController"
Cohesion: 0.13
...
### Community 287 - "extra"
Cohesion: 0.13
Nodes (19): createInvoice(), deleteInvoice(), generateInvoiceNumber(), getInvoice(), getInvoices(), getInvoiceSettings(), saveInvoiceSettings(), PrintInvoicePage() (+11 more)
...
### Community 306 - "keywords"
Cohesion: 0.12
Nodes (13): A, AB, B, clip, __dir, even, havKm(), hs (+5 more)

### Community 307 - "post-autoload-dump"
Cohesion: 0.33
Nodes (6): clip-path for Animation, Comparison sliders, Hold-to-delete pattern, Image reveals on scroll, Tabs with perfect color transitions, The inset shape

### Community 313 - "autoload-dev"
Cohesion: 0.33
...
Cohesion: 0.04
Nodes (16): getRestaurantAnalytics(), resetPassword(), AnalyticsClient(), Period, ResetPasswordForm(), hashPassword(), createPrismaClient(), g (+8 more)
...
### Community 324 - "keywords"
Cohesion: 0.40
Nodes (5): 3D transforms for depth, CSS Transform Mastery, scale() scales children too, transform-origin, translateY with percentages

### Community 325 - "post-autoload-dump"
Cohesion: 0.40
Nodes (5): Asymmetric enter/exit timing, Cohesion matters, Review your work the next day, The opacity + height combination, The Sonner Principles (Building Loved Components)

### Community 330 - "@aws-sdk/client-s3"
Cohesion: 0.40
Nodes (5): Interruptibility advantage, Spring Animations, Spring-based mouse interactions, Spring configuration, When to use springs

### Community 332 - "indexedDB.ts"
Cohesion: 0.25
Nodes (11): useOfflineSync(), posApiFetch(), CartItem, deleteOfflineOrder(), getOfflineOrders(), initPOSDb(), OfflineOrder, PaymentItem (+3 more)

### Community 333 - "class-variance-authority"
Cohesion: 0.50
...
### Community 533 - "MapTiler maps in Remotion"
Cohesion: 0.18
Nodes (11): Choose the source for each map element, Drawing rivers, Files, Hybrid, Keep it minmal, MapTiler maps in Remotion, MapTiler SDK (`@maptiler/sdk`), MapTiler vector (+3 more)

### Community 535 - "3D Flyover — architecture reference"
Cohesion: 0.20
...
### Community 536 - "Using videos in Remotion"
Cohesion: 0.20
...
### Community 539 - "remotion-best-practices/remotion-markup/remotion-maps/techniques/mapbox/TECHNIQUE.md"
Cohesion: 0.20
...
### Community 540 - "remotion-best-practices/remotion-markup/remotion-maps/techniques/maplibre/TECHNIQUE.md"
Cohesion: 0.20
Nodes (9): Animated flight route example, Basic map example, Camera guidance, Core rules, Lines, Markers and labels, Prerequisites, Rendering (+1 more)

### Community 541 - "3D Flyover — architecture reference"
Cohesion: 0.20
Nodes (9): 1. Provider initialization, 2. The camera path — structure & generation, 3. Camera animation per frame (position, heading, pitch, bank), 3D Flyover — architecture reference, 4. The feel — proven water-wars values, 5. The complete component, 6. Render, City (+1 more)
...
Cohesion: 0.22
Nodes (8): 1. The render harness (per frame), 2. Timing model — time-based; beat length derived from the sequences, 3. Provider-vector animation, 4. Custom line animation — reveal + electric draw-head, 5. Country animation — border draws → fill blooms → label rises, 6. Labels — HTML overlay, projected each frame, 7. Camera — fixed map plate for any movement, Map Explainer — architecture reference

### Community 549 - "Audio Visualization in Remotion"
Cohesion: 0.22
...
### Community 550 - "Using Animated images in Remotion"
Cohesion: 0.22
...
### Community 553 - "Map Explainer — architecture reference"
Cohesion: 0.22
Nodes (8): 1. The render harness (per frame), 2. Timing model — time-based; beat length derived from the sequences, 3. Provider-vector animation, 4. Custom line animation — reveal + electric draw-head, 5. Country animation — border draws → fill blooms → label rises, 6. Labels — HTML overlay, projected each frame, 7. Camera — fixed map plate for any movement, Map Explainer — architecture reference

### Community 554 - "Audio Visualization in Remotion"
Cohesion: 0.22
Nodes (8): Audio Visualization in Remotion, Bass-Reactive Effects, Loading Audio Data, Postprocessing, Prerequisites, Spectrum Bar Visualization, Volume-Based Waveform, Waveform Visualization

### Community 555 - "Using Animated images in Remotion"
Cohesion: 0.22
Nodes (8): Alternative, Basic usage, Getting GIF duration, Looping behavior, Playback speed, Sizing and fit, Styling, Using Animated images in Remotion
...
### Community 558 - "Map Explainer — basemap & geo prep"
Cohesion: 0.25
Nodes (7): `anchor` — label centre via pole of inaccessibility, Basemap styling — strip the clutter, `border` — complete source geometry, Map Explainer — basemap & geo prep, `../scripts/prep-geo.mjs` → outputs, `stop` — when a country lights up, Tuning the geo prep for a new scenario

### Community 559 - "Using `<HtmlInCanvas>` in Remotion"
Cohesion: 0.25
Nodes (7): 2D effect with `onPaint`, Async `onPaint`, Basic usage, Enabling WebGL during renders, Nesting, Using `<HtmlInCanvas>` in Remotion, WebGL effects

### Community 560 - "remotion-best-practices/remotion-markup/light-leaks.md"
Cohesion: 0.25
Nodes (7): Basic usage with TransitionSeries, Customizing the look, Light leak overlay component, Light Leaks, Options, Prerequisites, Standalone usage

### Community 561 - "Map Explainer — basemap & geo prep"
Cohesion: 0.25
Nodes (7): `anchor` — label centre via pole of inaccessibility, Basemap styling — strip the clutter, `border` — complete source geometry, Map Explainer — basemap & geo prep, `../scripts/prep-geo.mjs` → outputs, `stop` — when a country lights up, Tuning the geo prep for a new scenario

### Community 562 - "Map Explainer — basemap & geo prep"
Cohesion: 0.25
Nodes (7): `anchor` — label centre via pole of inaccessibility, Basemap styling — strip the clutter, `border` — complete source geometry, Map Explainer — basemap & geo prep, `../scripts/prep-geo.mjs` → outputs, `stop` — when a country lights up, Tuning the geo prep for a new scenario

### Community 563 - "Using `<HtmlInCanvas>` in Remotion"
Cohesion: 0.25
Nodes (7): 2D effect with `onPaint`, Async `onPaint`, Basic usage, Enabling WebGL during renders, Nesting, Using `<HtmlInCanvas>` in Remotion, WebGL effects

### Community 564 - "skills/remotion-markup/light-leaks.md"
Cohesion: 0.25
Nodes (7): Basic usage with TransitionSeries, Customizing the look, Light leak overlay component, Light Leaks, Options, Prerequisites, Standalone usage

### Community 565 - "Map Explainer — basemap & geo prep"
Cohesion: 0.25
Nodes (7): `anchor` — label centre via pole of inaccessibility, Basemap styling — strip the clutter, `border` — complete source geometry, Map Explainer — basemap & geo prep, `../scripts/prep-geo.mjs` → outputs, `stop` — when a country lights up, Tuning the geo prep for a new scenario

### Community 566 - "Using Three.js and React Three Fiber in Remotion"
Cohesion: 0.29
...
### Community 567 - "Measuring text in Remotion"
Cohesion: 0.29
...
### Community 569 - "remotion-best-practices/remotion-markup/sequencing.md"
Cohesion: 0.29
Nodes (6): Frame References Inside Sequences, Nested Sequences, Nesting compositions within another, Premounting, Series, Series with overlaps

### Community 570 - "remotion-best-practices/remotion-markup/timing.md"
Cohesion: 0.29
Nodes (6): Animating scale, Bézier easing, Multiple keyframes, Posterization, Spring easing, Studio-editable animation patterns

### Community 571 - "Using Three.js and React Three Fiber in Remotion"
Cohesion: 0.29
Nodes (6): Animate using `useCurrentFrame()`, No animations not driven by `useCurrentFrame()`, Prerequisites, Using `<Sequence>` inside `<ThreeCanvas>`, Using Three.js and React Three Fiber in Remotion, Using ThreeCanvas
...
### Community 575 - "skills/remotion-markup/timing.md"
Cohesion: 0.29
Nodes (6): Animating scale, Bézier easing, Multiple keyframes, Posterization, Spring easing, Studio-editable animation patterns

### Community 577 - "#r"
Cohesion: 0.33
Nodes (7): fa(), ga(), #l(), ma(), #r(), startInternalTransaction(), Te()

### Community 578 - "Map element data sources"
Cohesion: 0.33
Nodes (5): Custom geodata mode, Decision rule, Hybrid mode, Map element data sources, MapTiler vector mode

### Community 579 - "Moving Map Render Stability"
Cohesion: 0.33
...
### Community 580 - "Moving Map Render Stability"
Cohesion: 0.33
Nodes (5): Moving Map Render Stability, Plate sizing and sharpness, Required pattern: fixed map plate, Symptom and cause, Verification

### Community 581 - "Moving Map Render Stability"
Cohesion: 0.33
Nodes (5): Moving Map Render Stability, Plate sizing and sharpness, Required pattern: fixed map plate, Symptom and cause, Verification

### Community 582 - "Map element data sources"
Cohesion: 0.33
Nodes (5): Custom geodata mode, Decision rule, Hybrid mode, Map element data sources, MapTiler vector mode

### Community 583 - "Moving Map Render Stability"
Cohesion: 0.33
Nodes (5): Moving Map Render Stability, Plate sizing and sharpness, Required pattern: fixed map plate, Symptom and cause, Verification

### Community 584 - "Map element data sources"
Cohesion: 0.33
Nodes (5): Custom geodata mode, Decision rule, Hybrid mode, Map element data sources, MapTiler vector mode
...
### Community 588 - "Map element data sources"
Cohesion: 0.33
Nodes (5): Custom geodata mode, Decision rule, Hybrid mode, Map element data sources, MapTiler vector mode

### Community 589 - "Moving Map Render Stability"
Cohesion: 0.33
Nodes (5): Moving Map Render Stability, Plate sizing and sharpness, Required pattern: fixed map plate, Symptom and cause, Verification

### Community 590 - "Flyover data sources"
Cohesion: 0.40
Nodes (4): City, Flyover data sources, Landscape, Why not extruded buildings

### Community 591 - "3D Flyover — troubleshooting"
Cohesion: 0.40
Nodes (4): 3D Flyover — troubleshooting, Gotchas checklist, Symptom → fix, The headless dead-end (why we render through Remotion)

### Community 593 - "Using fonts in Remotion"
Cohesion: 0.40
Nodes (4): Google Fonts with @remotion/google-fonts, Prerequisites, Using fonts in Remotion, Using in components

### Community 594 - "remotion-best-practices/remotion-markup/local-fonts.md"
Cohesion: 0.40
Nodes (4): Available options, Loading a local font, Loading multiple weights, Prerequisites

### Community 595 - "Using Lottie Animations in Remotion"
Cohesion: 0.40
Nodes (4): Displaying a Lottie file, Prerequisites, Styling and animating, Using Lottie Animations in Remotion

### Community 596 - "Delaying, trimming"
Cohesion: 0.40
Nodes (5): Delaying, trimming, durationInFrames, Fallback, from, `trimBefore`

### Community 597 - "Flyover data sources"
Cohesion: 0.40
Nodes (4): City, Flyover data sources, Landscape, Why not extruded buildings

### Community 598 - "3D Flyover — troubleshooting"
Cohesion: 0.40
Nodes (4): 3D Flyover — troubleshooting, Gotchas checklist, Symptom → fix, The headless dead-end (why we render through Remotion)

### Community 600 - "Flyover data sources"
Cohesion: 0.40
Nodes (4): City, Flyover data sources, Landscape, Why not extruded buildings

### Community 601 - "3D Flyover — troubleshooting"
Cohesion: 0.40
Nodes (4): 3D Flyover — troubleshooting, Gotchas checklist, Symptom → fix, The headless dead-end (why we render through Remotion)

### Community 603 - "Using fonts in Remotion"
Cohesion: 0.40
Nodes (4): Google Fonts with @remotion/google-fonts, Prerequisites, Using fonts in Remotion, Using in components

### Community 604 - "skills/remotion-markup/local-fonts.md"
Cohesion: 0.40
Nodes (4): Available options, Loading a local font, Loading multiple weights, Prerequisites

### Community 605 - "Using Lottie Animations in Remotion"
Cohesion: 0.40
Nodes (4): Displaying a Lottie file, Prerequisites, Styling and animating, Using Lottie Animations in Remotion

### Community 606 - "Flyover data sources"
Cohesion: 0.40
Nodes (4): City, Flyover data sources, Landscape, Why not extruded buildings

### Community 607 - "3D Flyover — troubleshooting"
Cohesion: 0.40
Nodes (4): 3D Flyover — troubleshooting, Gotchas checklist, Symptom → fix, The headless dead-end (why we render through Remotion)

### Community 609 - "Delaying, trimming"
Cohesion: 0.40
Nodes (5): Delaying, trimming, durationInFrames, Fallback, from, `trimBefore`

### Community 610 - "./index-browser"
Cohesion: 0.40
...
### Community 613 - "skills/remotion-markup/images.md"
Cohesion: 0.50
...
## Knowledge Gaps
- **6636 isolated node(s):** `FlyoverMode`, `__dir`, `START`, `clip`, `even` (+6631 more)
...
- **Why does `dependencies` connect `dependencies` to `@prisma/client`, `remotion`, `fast-check`, `tailwind-merge`, `tailwindcss-animate`, `@tiptap/extension-underline`, `@tiptap/react`, `package.json`, `framer-motion`, `@libsql/client`, `react`, `lucide-react`, `next`, `next-themes`, `pdf-lib`, `@prisma/adapter-better-sqlite3`, `@prisma/adapter-libsql`, `react-dom`, `remeda`, `@tiptap/extension-image`, `better-sqlite3`, `effect`, `fast-check`, `gsap`, `next-themes`, `zustand`, `react-dom`, `react-markdown`, `@react-three/fiber`, `@remotion/captions`, `@remotion/paths`, `@remotion/player`, `@remotion/shapes`, `three`, `zustand`, `waiter.ts`?**
...
- **What connects `FlyoverMode`, `__dir`, `START` to the rest of the system?**
  _6636 weakly-connected nodes found - possible documentation gaps or missing edges._
